...
public class ShowAccountRoleResource {

    private static final String USER_NAME = "username";
    private static final String USER_ROLE = "role";

    Logger LOG = Logger.getLogger(ShowAccountRoleResource.class.getName());
    Datastore datastore = DatastoreOptions.getDefaultInstance().getService();

    public ShowAccountRoleResource () {}

    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response doShowAccountRoleResource(AppRequest<ChangeAccountRoleRequest> request) {
        ...
        try { 
            ...
            return new AppResponse <UserSummary>("success", new UserSummary( user.getString(USER_NAME), user.getString(USER_ROLE))).toResponse();
